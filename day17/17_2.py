...
def set_floor(grid, y, x_min, x_max, char):
...
def run_floor(grid, x, y):
    ...
    floor_char = '~' if not (fall_left or fall_right or seen_drip_l or seen_drip_r) else '|'
    set_floor(grid, y, x_left+1, x_right-1, floor_char)
